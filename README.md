...
<p>
  ...
  <a href="https://github.com/WinkelZoeker/winkelzoeker-api/graphs/commit-activity" target="_blank">
    <img alt="Maintenance" src="https://img.shields.io/badge/maintenance-as--is-yellow.svg)" />
  </a>
...
* For production system, use of a better secret management tool instead of gpg, like [SecretHub](https://secrethub.io/), [Hashicorp Vault](https://www.vaultproject.io/) or [AWS Parameter Store/Secrets Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-parameter-store.html).
